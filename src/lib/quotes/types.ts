...
export const QUOTE_STATUS_CONFIG: Record<QuoteStatus, { label: string; variant: string; color: string }> = {
  draft: { label: 'Draft', variant: 'outline', color: 'bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-500/20' },
  sent: { label: 'Sent', variant: 'outline', color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20' },
  accepted: { label: 'Accepted', variant: 'outline', color: 'bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20' },
  declined: { label: 'Declined', variant: 'outline', color: 'bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20' },
  expired: { label: 'Expired', variant: 'outline', color: 'bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20' },
  void: { label: 'Void', variant: 'outline', color: 'bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20' },
};
